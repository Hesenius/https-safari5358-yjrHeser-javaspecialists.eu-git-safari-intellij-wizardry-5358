...
class TablePanel extends JPanel {
    ...
    public TablePanel(final String tableName, final JTabbedPane parent) {
        super();
        this.parent = parent;
        setLayout(new BorderLayout());

        try {
            model = TableModelFactory.getResultSetTableModel(tableName);
    ...
    private void initToolBar() {
        ...
        close.addActionListener(e -> parent.remove(TablePanel.this));
    ...
    private void modifyRow() {
        ...
        final DataInputFrame frame = new DataInputFrame("Modify Row",
            columnNames);
