...
class PrinterLayoutInputFrame extends JFrame {
    ...
    private JComboBox packhouses;
    private JComboBox lines;
    private JComboBox printers;


    private PrinterLayoutInputFrame(final String title, final String[] rowNames, final boolean useTitles) throws HeadlessException {
        super();
        ...
        packhouses = new JComboBox(new DatabaseComboModel("packhousetemplates", "PackhouseName"));
        lines = new JComboBox(new DatabaseComboModel("packhousetemplates", "LineName"));
        printers = new JComboBox(new DatabaseComboModel("Printer", "PrinterID"));
    ...
    public PrinterLayoutInputFrame(final String title, final String[] rowNames) throws HeadlessException {
    ...
    private void createBottomPanel() {
        ...
        ok.addActionListener(e -> {
            ...
            PrinterLayoutInputFrame.this.dispose();
        });
    ...
    private void createMainPanel() {
        ...
        for (int i = 1; i < formattedNames.length; i++) {
            ...
            line.add(labelPanel);
            if (i == 1) {
                textFields[1] = packhouses;
            } else if (i == 2) {
                textFields[i - 1] = lines;
            } else {
                textFields[i - 1] = printers;
            }
        ...
        final JScrollPane scroller = new JScrollPane(bla, JScrollPane.VERTICAL_SCROLLBAR_AS_NEEDED, JScrollPane.HORIZONTAL_SCROLLBAR_NEVER);
        scroller.setPreferredSize(new Dimension(charHeight * 27, charHeight * 25));
